class TableBody
{
  ...
  #carritoSetAttribute()
  {
    this.nodes.tdPrecio.setAttribute("style", "text-align:right");
    this.nodes.tdCantidad.setAttribute("style", "text-align:right");
    this.nodes.tdSubtotal.setAttribute("style", "text-align:right");
  }
