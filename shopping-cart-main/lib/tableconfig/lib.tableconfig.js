class TableConfig
{
  ...
  theadThStyle()
  {
    this.nodes.precioTh.setAttribute("class", "th-number");
    this.nodes.cantidadTh.setAttribute("class", "th-number");
    this.nodes.subtotalTh.setAttribute("class", "th-number");
  }
  ...
  tfootSetAttribute()
  {
    this.nodes.th3.setAttribute("class", "th-number");
    this.nodes.th4.setAttribute("class", "th-number");
  }
